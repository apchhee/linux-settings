...
tags = {
     names = {"www", "im", "prog", 4, 5, 6, 7, "mail", "moc"},
     layout = {layouts[10], layouts[2], layouts[2], layouts[2], layouts[2],
               layouts[1], layouts[1], layouts[10], layouts[2]
}}
...
--    awful.key({ modkey,           }, "Left",   awful.tag.viewprev       ), -- conflict with moving windows in floating mode!
...
-- awful.util.spawn_with_shell("<bash-command-here>")
